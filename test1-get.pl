# This code converts an url to pdf in Perl using SelectPdf REST API through a GET request. 
...
my $requesturl = URI->new($api_endpoint);
$requesturl->query_form($parameters);
